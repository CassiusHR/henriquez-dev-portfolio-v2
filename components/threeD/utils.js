...
const MAX_RADIUS = 15;
const DEPTH = 3;
const LEFT_COLOR = "cccccc";
const RIGHT_COLOR = "000000";
const NUM_POINTS = 2000;

const gradientStop = (ratio) => {
...
export const pointsInner = Array.from(
    ...
    const x = Math.cos(randomAngle) * ramdomRadius;
    const y = Math.sin(randomAngle) * ramdomRadius;
